<x-guest-layout>
    <!-- Main Hero Content -->
      <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center welcome-section"
         style="background-image: url('images/beans-1834984_960_720.jpg')">
        <h1 class="font-pacifico text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-300 md:text-center sm:leading-none lg:text-5xl text-shadow-md">
            <span class="inline md:block">WELCOME TO </span>
            <span class="inline md:block">SAUNG DMS  </span>
        </h1>
        ...
        <div class="flex flex-col items-center mt-12 text-center">
            <span class="relative inline-flex w-full md:w-auto">
                <a href="{{ route('reservations.step-one') }}" type="button"
                   class="menu-button inline-flex items-center justify-center px-6 py-2 text-base font-bold leading-6 text-white rounded-full lg:w-full md:w-auto hover:bg-green-500 focus:outline-none">
   ...
   <section id="blog" class="px-2 py-32 bg-black md:px-0">
    ...
    @endif        
  <section class="pt-4 pb-12 bg-[#2C3E50]"> <!-- Updated dark blue background -->
    <div class="my-16 text-center">
        <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-300">
            Testimonial
        </h2>
        ...
        <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
                    deserunt ea doloremque natus error, rerum quas odio quaerat nam ex commodi hic, suscipit in a veritatis
                    pariatur minus consequuntur!</p>
            </div>
            <div class="flex justify-end mt-4">
                <a href="#" class="text-xl font-medium text-teal-500">John Doe</a>
            </div>
        </div>
        <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
            <div class="flex justify-center -mt-16 md:justify-end">
